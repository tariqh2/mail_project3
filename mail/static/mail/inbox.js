...
function view_email(id){
  ...
  .then(email => {
    ...
    // InnerHtml of the email detail view div
    ...
    // Establishing archiving logic

    const btn_arch = document.createElement('button');
    btn_arch.innerHTML =  email.archived ? "Unarchive" : "Archive";
    btn_arch.className =  email.archived ? "btn btn-outline-success" : "btn btn-outline-danger";  
    ...
    btn_reply.addEventListener('click', function() {
      compose_email();
        ...
        // Prepopulating reply form fields
...
function load_mailbox(mailbox) {
  ...
  // Get emails from the mailbox and user
...
.then(emails => {
    ...
    emails.forEach(singleEmail => {
      ...
      // Change background colour based on if email read or not
